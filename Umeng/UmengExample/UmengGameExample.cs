...
public class UmengGameExample : MonoBehaviour
{
    ...
    public static UmengGameExample nInstace;
...
#if UNITY_IPHONE
        GA.StartWithAppKeyAndChannelId("5d145a3e0cafb212cd000691", "App Store");
#elif UNITY_ANDROID
        GA.StartWithAppKeyAndChannelId("5d145a3e0cafb212cd000691", "Android");
#endif
        // GA.SetLogEnabled(true);
    }
    public void SetLeve(int nLeve)
    {
       GA.Event("level" ,nLeve+"");
    }

    public void SetLBLeve(int nLeve)
    {
        GA.Event("lb_leve", nLeve + "");
    }
    ...
    //    if (GUI.Button(new Rect(x, y, w, h), "ClearPreProperties"))
    //    {

    //        Analytics.ClearPreProperties();
