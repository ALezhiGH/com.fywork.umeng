...
namespace Umeng
{
    ...
    public partial class Analytics
    {
        ...
        //测试模式获得id
        //GetTestDeviceInfo返回的是一个的id数组
        //ios 使用 GetTestDeviceInfo()[0]
        //android使用 GetTestDeviceInfo()[0]和GetTestDeviceInfo()[1]
        public static string[] GetTestDeviceInfo()
		{
            ...
            return UMConfigure.CallStatic<String[]>("getTestDeviceInfo", Context);

#elif UNITY_IPHONE

            string[] idList =new string[2];
            idList[0]=_GetDeviceID();
            idList[1] = null;
            return idList;
